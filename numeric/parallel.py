"""
Module containing specific classes to build finite-difference models for simulating two-dimensional parallel
groundwater flow.
"""
import numpy as np
...
class StressPeriod(BaseStressPeriod):
    ...
    -------
    add_kh(kh, ch) :
                  Add horizontal flow parameters.
    add_kv(kv, cv) :
...
class Model(BaseModel):
    ...
    ----------
    grid : Grid object
         Two-dimensional rectilinear finite-difference grid.
